...
- Updated `AGENTS.md` ticket guidance to point to `hubo_kb/tickets/...` paths.
- Updated `.pi/skills/ticket-done/SKILL.md` so ticket completion flow moves files to `hubo_kb/tickets/done`.
- Added `tickets/README.md` as a compatibility pointer to the new vault-based ticket location.
